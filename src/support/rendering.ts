...
function resultContainer() {
    ...
    return {
        ...
        setValue: function (val: any) { return updateResult(val); },
        setError: function (err: any) { return updateResult(undefined, err); },
    };
}
...
Cypress.Commands.add("mountHookWrap", function (hookFn, Wrapper) {
    ...
    var componentTest = React.createElement(Wrapper, undefined, React.createElement(TestHook, {
        callback: hookFn,
        onError: setError,
        children: setValue,
    }));
